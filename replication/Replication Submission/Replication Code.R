...
######EDIT: Any edits to existing logistic models are listed directly below the existing model######


## check reference and levels for each categorical variable
contrasts(COVID_data$Classification)

class(COVID_data$Classification)
...
# work
fullmod_work <- glm(leavehomereason___1 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                    data = COVID_data_notessential,
                    family = "binomial")
summary(fullmod_work)

class(COVID_data_notessential$depression_dichotf)

#Interaction Effect for Leaving Home for Work Regression

fullmod_work2 <- glm(leavehomereason___1 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel + 
                     depression_dichotf:agegroup,
                    data = COVID_data_notessential,
                    family = "binomial")
summary(fullmod_work2)



fullmod_work3 <- glm(leavehomereason___1 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel + agegroup:Classification, 
                    data = COVID_data_notessential,
                    family = "binomial")
summary(fullmod_work3)


#Model Testing
AIC(fullmod_work, fullmod_work2)
AIC(fullmod_work, fullmod_work3)

anova(fullmod_work, fullmod_work2, test = "Chisq")
anova(fullmod_work, fullmod_work3, test = "Chisq")
...
# grocery shopping
fullmod_grocery <- glm(leavehomereason___3 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                       data = COVID_data_notessential,
                       family = "binomial")
summary(fullmod_grocery)

#Adding interactive effects to grocery shopping model

fullmod_grocery2 <- glm(leavehomereason___3 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel
                       + depression_dichotf:agegroup, 
                       data = COVID_data_notessential,
                       family = "binomial")
summary(fullmod_grocery2)



fullmod_grocery3 <- glm(leavehomereason___3 ~ Classification + agegroup:Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                       data = COVID_data_notessential,
                       family = "binomial")
summary(fullmod_grocery3)

#Model testing

anova(fullmod_grocery, fullmod_grocery2, test = "Chisq")

anova(fullmod_grocery, fullmod_grocery3, test = "Chisq")
...
fullmod_othershop <- glm(leavehomereason___4 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                         data = COVID_data_notessential,
                         family = "binomial")
summary(fullmod_othershop)

#Adding interactive effects to essential shopping model

fullmod_othershop2 <- glm(leavehomereason___4 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel + 
                          depression_dichotf:agegroup, data = COVID_data_notessential,
                         family = "binomial")
summary(fullmod_othershop2)

fullmod_othershop3 <- glm(leavehomereason___4 ~ Classification + agegroup:Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                         data = COVID_data_notessential,
                         family = "binomial")
summary(fullmod_othershop3)

#Model testing
anova(fullmod_othershop, fullmod_othershop2, test = "Chisq")
anova(fullmod_othershop, fullmod_othershop3, test = "Chisq")
...
# exercise
fullmod_exercise <- glm(leavehomereason___5 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                        data = COVID_data_notessential,
                        family = "binomial")
summary(fullmod_exercise)

#Interaction effects for exercise model

fullmod_exercise2 <- glm(leavehomereason___5 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel + depression_dichotf:agegroup, 
                        data = COVID_data_notessential,
                        family = "binomial")
summary(fullmod_exercise2)



fullmod_exercise3 <- glm(leavehomereason___5 ~ Classification + Classification:agegroup + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                        data = COVID_data_notessential,
                        family = "binomial")
summary(fullmod_exercise3)

#Model Testing
anova(fullmod_exercise, fullmod_exercise2, test = "Chisq")
anova(fullmod_exercise, fullmod_exercise3, test = "Chisq")

AIC(fullmod_exercise, fullmod_exercise2)#lower AIC score
AIC(fullmod_exercise, fullmod_exercise3)
...
# walking dog
fullmod_dog <- glm(leavehomereason___6 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                   data = COVID_data_notessential,
                   family = "binomial")
summary(fullmod_dog)

#Interactive effects with walking the dog model

fullmod_dog2 <- glm(leavehomereason___6 ~ Classification + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel + depression_dichotf:agegroup, 
                   data = COVID_data_notessential,
                   family = "binomial")
summary(fullmod_dog2)



fullmod_dog3 <- glm(leavehomereason___6 ~ Classification + Classification:agegroup + sexf + agegroup + edu1 + hhincomef + childrenf + depression_dichotf + comorbidf_relevel, 
                   data = COVID_data_notessential,
                   family = "binomial")
summary(fullmod_dog3)

#Model Testing
anova(fullmod_dog, fullmod_dog2, test = "Chisq")
anova(fullmod_dog, fullmod_dog3, test = "Chisq")

AIC(fullmod_dog, fullmod_dog2)#lower AIC score
AIC(fullmod_dog, fullmod_dog3)
...
fullmod_leavehome <- glm(localsiphours_1 ~ Classification + sexf + agegroup + hhincomef + edu1 + childrenf + depression_dichotf + comorbidf_relevel, 
                         data = COVID_data_notessential,
                         family = "binomial")
